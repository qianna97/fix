...
<html>
<head>
	<title>Kompetitor SNMPTN kota - Lilin</title>
	<!--Import CSS-->
...
<body>
				...
				<li>
					<a class="collapsible-header active"><i class="material-icons">&#xE242;</i>Kompetitor SNMPTN</a></a>
						<div class="collapsible-body">
							<ul>
								<li><a href="kompetitor_kota.html" class="aktif"><i class="material-icons">&#xE7F1;</i>Se-kota</a></li>
	...
	<div class="loader">
		...
		<div class="container" id="pilihan1">
			...
			<p>Anda memiliki <span><?php echo "$jml_data_1"?></span> orang kompetitor di kota Anda dengan data sebagai berikut.</p>
			<ul class="collapsible" data-collapsible="accordion">
			 	<?php $list_id_kota = $this->db->query("SELECT * from user where kota='$kota' ORDER BY ratanilaisemua DESC"); ?>
			 	<?php foreach ($list_id_kota->result_array() as $kota_sama) { ?>
			 	<?php $id = $kota_sama['userID']; ?>
			 	<?php $nama_komp = $kota_sama['name']; ?>
			 	<?php $nilai_komp = $kota_sama['ratanilaisemua']; ?>
				...
				<li>
					...
					<div class="collapsible-body">
						...
						<p>
							...
							<span class="value"><?php echo $kota;?></span>
						</p>
						<?php $h++; ?>
		...
		<div class="container" id="pilihan2" style="display:none">
			...
			<p>Anda memiliki <span><?php echo "$jml_data_2"?></span> orang kompetitor di kota Anda dengan data sebagai berikut.</p>
			<ul class="collapsible" data-collapsible="accordion">
			 	<?php $list_id_kota = $this->db->query("SELECT * from user where kota='$kota' ORDER BY ratanilaisemua DESC"); ?>
			 	<?php foreach ($list_id_kota->result_array() as $kota_sama) { ?>
			 	<?php $id = $kota_sama['userID']; ?>
		...
		<div class="container" id="pilihan3" style="display:none">
			...
			<p>Anda memiliki <span><?php echo "$jml_data_3"?></span> orang kompetitor di kota Anda dengan data sebagai berikut.</p>
			<ul class="collapsible" data-collapsible="accordion">
			 	<?php $list_id_kota = $this->db->query("SELECT * from user where kota='$kota' ORDER BY ratanilaisemua DESC"); ?>
			 	<?php foreach ($list_id_kota->result_array() as $kota_sama) { ?>
			 	<?php $id = $kota_sama['userID']; ?>
